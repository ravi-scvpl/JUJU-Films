...
const storytellingvideo = '/assets/juju_storytelling.mp4';
    ...
    return (
        <li className="work">
            ...
            >
                ...
                <Link className="work__link" href={video.link || "#"} aria-label={video.title} onClick={(e) => { e.preventDefault(); onVideoClick(video); }}>
