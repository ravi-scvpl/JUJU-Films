            ...
            {featuredArticle && (
                <section className="reveal-on-scroll juju-featured-section">
                    ...
                    <div className="juju-featured-image-container">
                        <Link href={`/influence/${featuredArticle.slug}`}>
                            <img
                    ...
                    <div className="juju-featured-content-grid">
                        <div>
                            <Link href={`/influence/${featuredArticle.slug}`} style={{ textDecoration: 'none', color: '#fff' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                            ...
                            <Link href={`/influence/${featuredArticle.slug}`} className="juju-read-more">
                                View Case Study →
                            </Link>
                        </div>
                    </div>
                    ...
                    {remainingArticles.map((article, index) => {
                        ...
                        return (
                            <div key={article.id} style={gridStyle} className={`reveal-on-scroll ${delayClass}`}>
                                <Link href={`/influence/${article.slug}`} style={{ textDecoration: 'none', color: 'inherit' }}>
